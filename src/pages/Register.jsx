  ...
  const handleSubmit = async(e) => {
    ...
    try {
        ...
        if (response.data.success) {
          ...
          navigate('/'); // Optionally redirect after Register
          } else {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex justify-center items-center">
      <div className="bg-gray-800 p-8 rounded-xl w-full sm:w-96 shadow-lg">
        <h2 className="text-2xl font-bold text-center text-white mb-6">Register to Your Account</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              value={name}
              onChange={(e) => setName(e.target.value) } // Handle change based on input type
        ...
        {/* Sign Up Option */}
        <div className="text-center mt-4">
          <p className="text-sm text-gray-300">Don't have an account? <a href="#" className="text-blue-400">Sign Up</a></p>
        </div>
      </div>
    </div>
  );
